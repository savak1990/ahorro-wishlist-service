...
type WishRepository interface {
	...
	GetUserWishes(ctx context.Context, userId string, lsi string, scanForward bool, limit int32, nextToken string) ([]m.Wish, string, error)
	GetAllWishes(ctx context.Context, gsi string, scanForward bool, limit int32, nextToken string) ([]m.Wish, string, error)
